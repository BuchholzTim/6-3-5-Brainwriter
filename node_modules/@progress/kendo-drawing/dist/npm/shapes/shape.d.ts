...
export abstract class Shape<T> extends Element {
  /**
   * Sets the fill of the Shape  (see the [basic usage example]({% slug basicshapes_drawing %}#toc-drawing-the-gradient)).
   *
   * @param color - The [fill color]({% slug api_kendo-drawing_filloptions %}#toc-color) to set.
   * @param opacity - The [fill opacity]({% slug api_kendo-drawing_filloptions %}#toc-opacity) to set.
   * @return - The current instance to allow chaining.
   */
  fill(color: string, opacity?: number): T;

  /**
   * Sets the [stroke]({% slug api_kendo-drawing_strokeoptions %}) of the Shape.
   *
   * @param color - The [stroke color]({% slug api_kendo-drawing_strokeoptions %}#toc-color) to set.
   * @param width - The [stroke width]({% slug api_kendo-drawing_strokeoptions %}#toc-width) to set.
   * @param opacity - The [stroke opacity]({% slug api_kendo-drawing_strokeoptions %}#toc-opacity) to set.
   * @return - The current instance to allow chaining.
   */
